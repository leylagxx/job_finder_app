            ...
            child: Column(
              ...
              children: [
                ...
                const ApplyFormHeadline(
                    headline: 'Портфодиоңызды жүктеңіз',
                    subheadline: 'Өзіңіз жайлы мәлеметтерді мұқият толтырыңыз'),
                UploadCvView(
                  onTap: () => pickCvFile(),
                  fileName: cvFileName,
                  fileSize: cvFileSize,
                    ...
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return CustomSuccessProcesses(
                          ...
                          subtitle:
                              'Сіз біздің командамыздан қызметкерді қабылдау туралы хабарландыру жайлы хабарлама аласыз.',
                          image: AppImages.kDataIlustration,
                          buttonText: 'Басты бетке',
