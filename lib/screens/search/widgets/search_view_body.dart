    ...
    return BlocBuilder<SearchJobsCubit, SearchJobsState>(
      builder: (context, state) {
        if (state is SearchJobsSuccess) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "${state.jobs.length} жұмыс ұсынылады",
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Басқа кілт сөздерді қолданып көріңіз, біз сізге нәтижелерді көрсете аламыз',
                      style: TextStyle(
                        fontSize: 14,
                        color: Color(0xff6B7280),
          ...
          return Text('Іздеу сәтсіз аяқталды: ${state.errMessage}');
        } else {
